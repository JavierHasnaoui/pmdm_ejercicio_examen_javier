...
class _VideoYoutubePageState extends State<VideoYoutubePage> {
  ...
  // el id de video sale de aqui: https://www.youtube.com/watch?v=FRikWU3kVGw
  Future<void> _initializeVideoPlayer() async {
    final videoId = 'FRikWU3kVGw';
...
137          mp4           1920x1080   1080p24       3.99 Mbit/s    46.37 MB       avc1.640028             video only
    */
    ...
    _videoPlayerController!.seekTo(Duration(seconds: 0)); // mover a una determinada posición
